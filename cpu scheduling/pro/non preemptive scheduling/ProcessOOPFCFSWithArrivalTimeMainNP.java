...
public void input(int n)
  { 
     for(int i=1;i<=n;i++)
      ...
      obj[0] = new ProcessOOPFCFSWithArrivalTime();
        obj[0].str="-";
  }
public void calTatWaiTime(int n)
  { 
      int timer=0,k=0,nop=0;
     while(true)
      {    
             k=0;
            for(int i=1;i<=n;i++)
...
public void ganttChart(int n)
    {   
         ...
         System.out.print("           ______________________________________________________________________________________________________________________________\n");
         System.out.print("            | ");
       for(int i=1;i<l;i++)
         { 
